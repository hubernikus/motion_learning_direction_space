...
if (__name__) == "__main__":
    ...
    if save_figure:
        plt.savefig(
            os.path.join("figures", name + "_gaussian_and_2d" + ".png"),
            bbox_inches="tight",
        )
    ...
    if save_figure:
        plt.savefig(
            os.path.join("figures", name + "_vectorfield" + ".png"), bbox_inches="tight"
        )
    ...
    if save_figure:
        plt.savefig(
            os.path.join("figures", name + "weights" + ".png"), bbox_inches="tight"
        )
