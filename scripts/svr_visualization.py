...
from motion_learning_direction_space.learner.svr_directional import DirectionalSVR
...
if (__name__) == "__main__":
    ...
    MainLearner.load_data_from_mat(file_name=dataset_name, n_samples=n_samples, attractor=attractor)
    MainLearner.fit()
